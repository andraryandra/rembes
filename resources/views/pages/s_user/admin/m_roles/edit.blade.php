    ...
    <div class="row my-4">
        ...
        <div class="col-md-4">
            <div class="card mb-3">
                <div class="card-body shadow-sm">
                    <div class="card-title d-flex align-items-center">
                        <h5 class="mb-0">Menu Ticket Show</h5>
                    </div>
                    <hr />
                    <div class="form-group">
                        @foreach ($permission as $value)
                            @if (strpos($value->name, 'submission-artikel-') === 0)
                                <div class="form-check my-2">
                                    <label class="form-check-label" for="permission_{{ $value->id }}">
                                        {{ Form::checkbox('permission[]', $value->id, in_array($value->id, $rolePermissions) ? true : false, ['class' => 'form-check-input', 'id' => 'permission_' . $value->id]) }}
                                        <span class="mx-2">{{ $value->name }}</span>
        ...
        <div class="col-md-4">
            <div class="card mb-3">
                <div class="card-body shadow-sm">
                    <div class="card-title d-flex align-items-center">
                        <h5 class="mb-0">Menu Rembeses Approved</h5>
                    </div>
                    <hr />
                    <div class="form-group">
                        @foreach ($permission as $value)
                            @if (strpos($value->name, 'submission-approved-') === 0)
                                <div class="form-check my-2">
                                    <label class="form-check-label" for="permission_{{ $value->id }}">
                                        {{ Form::checkbox('permission[]', $value->id, in_array($value->id, $rolePermissions) ? true : false, ['class' => 'form-check-input', 'id' => 'permission_' . $value->id]) }}
                                        <span class="mx-2">{{ $value->name }}</span>
        ...
        <div class="col-md-4">
            <div class="card mb-3">
                <div class="card-body shadow-sm">
                    <div class="card-title d-flex align-items-center">
                        <h5 class="mb-0">Menu Rembeses Success</h5>
                    </div>
                    <hr />
                    <div class="form-group">
                        @foreach ($permission as $value)
                            @if (strpos($value->name, 'submission-success-') === 0)
                                <div class="form-check my-2">
                                    <label class="form-check-label" for="permission_{{ $value->id }}">
                                        {{ Form::checkbox('permission[]', $value->id, in_array($value->id, $rolePermissions) ? true : false, ['class' => 'form-check-input', 'id' => 'permission_' . $value->id]) }}
                                        <span class="mx-2">{{ $value->name }}</span>
